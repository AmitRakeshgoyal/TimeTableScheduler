    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="2" cellspacing="3" align="center" id="timetable">
            ...
            <tr>
                ...
                <td style="text-align:center">11:25-11:30</td>
                <td style="text-align:center">11:30-12:20</td>
                <td style="text-align:center">12:20-1:10</td>
                <td style="text-align:center">1:10-1:40</td>
                <td style="text-align:center">1:40-3:20</td>
				<td style="text-align:center">3:20-5:00</td>
            </tr>
                <?php
                $table = null;
                if (isset($_POST['select_semester'])) {
                ...
                if (isset($_POST['select_semester']) || isset($_POST['select_teacher']) || isset($_GET['display'])) {
                    ...
                    while ($row = mysqli_fetch_assoc($q)) {
                        ...
                        echo "
                 <tr><td style=\"text-align:center\">{$row['day']}</td>
